...
export const useTimelineStore = create<TimelineState>()(
  ...
  guests: [
    { id: 'g-1', name: 'Nguyễn Văn A', phone: '0901234567', email: 'vana@gmail.com', idCard: '0123456789', nationality: 'Việt Nam', createdAt: new Date() },
    { id: 'g-2', name: 'Trần Thị B', phone: '0912345678', email: 'thib@gmail.com', idCard: '9876543210', nationality: 'Việt Nam', createdAt: new Date() },
    { id: 'g-3', name: 'John Smith', phone: '0923456789', email: 'john@example.com', nationality: 'USA', createdAt: new Date() },
  ],
  notifications: [
  ...
  setThreadMessages: (threadId, messages) => {
    ...
    }),
    {
      ...
      migrate: (_persistedState, fromVersion) => {
        // Bất cứ khi nào version tăng → xóa state cũ, dùng initialState
        console.log(`[StayOS] Store migrated from v${fromVersion} → v2. Resetting to fresh data.`);
