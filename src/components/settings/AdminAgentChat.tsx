...
export const AdminAgentChat = () => {
  ...
  return (
    <div className="flex flex-col h-[650px] bg-slate-50/50 rounded-2xl overflow-hidden border">
      {/* Header */}
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white px-6 py-4 flex items-center justify-between shrink-0 shadow-sm">
        ...
        ])} className="text-slate-400 hover:text-white rounded-xl text-xs flex gap-1 font-bold">
